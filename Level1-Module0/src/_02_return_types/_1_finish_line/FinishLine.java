...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		if(finished) {	
			...
			JOptionPane.showMessageDialog(null, "Wow! That's really far! Rob went " + distance + " pixels");
		}
		//7. Else use a pop up to say the robot did not finish and how far it went
		else {
			JOptionPane.showMessageDialog(null, "Better luck next time. Rob went " + distance + " pixels");
		}
	}
